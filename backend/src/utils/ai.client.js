        ...
        return [
                {
                        ...
                        content: [
                                ...
                                "각 결과 객체는 questionId (string), isCorrect (boolean), correctAnswer (string), mistakeAnalysis (배열 문자열), stepByStepSolution (배열 문자열), confidence (string|null), learningTips (string), explainLikeIm5 (string)를 반드시 포함해야 합니다.",
                                "각 항목, 각 단계, 설명 등은 모두 자연스러운 한국어 문장으로 작성하세요.",
                                "출력 예시(샘플 JSON) : { \"results\": [{ \"questionId\": \"abc123\", \"isCorrect\": true, \"correctAnswer\": \"1\", \"mistakeAnalysis\": [\"...\"]}] }",
